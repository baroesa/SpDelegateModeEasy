;window.CloudflareApps=window.Eager=window.CloudflareApps||window.Eager||{};window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="9662a3abe7128b30d0d83c48cb1a1120";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["yCEu4HqiqP1I"]={appId:"fRLxx0cn-Ae-",scope:{}};;CloudflareApps.installs["yCEu4HqiqP1I"].options={"account":{"accountId":"KGytV9Tg58GT","service":"viglink-service","userId":"140622"},"campaignKey":"60430423fdd47c16de0d1b741b15f71d"};;CloudflareApps.installs["T1F2fP3uWdgJ"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["T1F2fP3uWdgJ"].options={"domain":"","id":"UA-45296257-1","showDomain":false,"social":true};;if(CloudflareApps.matchPage(CloudflareApps.installs['T1F2fP3uWdgJ'].URLPatterns)){(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','https://www.google-analytics.com/analytics.js','ga');};if(CloudflareApps.matchPage(CloudflareApps.installs['T1F2fP3uWdgJ'].URLPatterns)){(function(){var options=CloudflareApps.installs['T1F2fP3uWdgJ'].options
...
window.ga('send','social','twitter','tweet',{page:targetUrl})}})}})}}())}(function(){var script = document.createElement('script');script.src = '/cdn-cgi/apps/body/eq4eXrUT9J110EZVPoZMCjwI9MA.js';document.head.appendChild(script);})();